...
#define kSubButtonWidth 145.0f
#define kSubButtonHeight 90.0f
...
//    [NSArray arrayWithArray:topicArray];
    ...
    self.scrollView.contentSize = CGSizeMake(15+(145 + 10) *imagesArr.count, 90);
    ...
    for (NSInteger i = 0; i < imagesArr.count; i ++) {
        ...
        UIButton *topicButton = [UIButton buttonWithType:UIButtonTypeCustom configure:^(UIButton *btn) {
            [btn setFrame:CGRectMake(15 + (kSubButtonWidth + 10) * i, 0, kSubButtonWidth, kSubButtonHeight)];
...
//            [btn setBackgroundImage:[UIImage imageNamed:@"2.0_placeHolder_long"] forState:UIControlStateNormal];
            ...
            [btn sd_setImageWithURL:[NSURL URLWithString:imagesArr[i]] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"2.0_placeHolder_long"]];
