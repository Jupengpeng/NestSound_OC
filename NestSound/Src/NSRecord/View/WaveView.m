...
- (void)drawRect:(CGRect)rect{
    ...
    self.realTimeView = [[UIView alloc]initWithFrame:CGRectMake(self.frame.size.width/40+self.waveDistance, 29 - self.desibelNum/2, ScreenWidth/375.0,self.desibelNum)];//21
