...
@implementation DeviceMusicWave
...
- (void)audioRecorderDidFinishRecording:(AVAudioRecorder *)recorder successfully:(BOOL)flag{
    ...
    if ([self.delegate respondsToSelector:@selector(recordWaveView:voiceRecorded:length:)]) {
        [self.delegate recordWaveView:self voiceRecorded:self.recordPath length:self.recordTime];
    }
    [self setNeedsDisplay];
}
