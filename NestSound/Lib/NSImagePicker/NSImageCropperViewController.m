//
//  NSImageCropperViewController.m
//  NestSound
//
...
@interface NSImageCropperViewController ()
...
@implementation NSImageCropperViewController
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(NSImageCropperDelegate)]) {
