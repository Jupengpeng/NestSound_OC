...
*
*******************************************************************************/
#ifndef __TT_WMADEC_H__
#define __TT_WMADEC_H__
...
#define	TT_ERR_WMA_BASE			0x82050000
#define TTErrWMAInvFrame        (TT_ERR_WMA_BASE | 0x0001)	
 ...
 */
DLLEXPORT_C TTInt32 ttGetWMADecAPI(TTAudioCodecAPI * pDecHandle);

typedef TTInt32 (*__GetWMADecAPI)(TTAudioCodecAPI * pDecHandle);

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif //__TT_WMADEC_H__
