...
#ifndef __TT_EXT_AUDIO_FILE_PARSER_H__
#define __TT_EXT_AUDIO_FILE_PARSER_H__
...
class CTTExtAudioFileParser : public CTTMediaParser
{
...
public: // Constructors and destructor
     ...
     * \brief						C++ constructor.
     */
	CTTExtAudioFileParser(ITTDataReader& aDataReader, ITTMediaParserObserver& aObserver);
    
	/*destructor*/
	virtual							~CTTExtAudioFileParser();
...
protected:
    ...
    TTWAVFormat                     iWavInfo;
    TTInt64                         iTotalPCMSize;
    TTUint                          iFrameTime;
};
