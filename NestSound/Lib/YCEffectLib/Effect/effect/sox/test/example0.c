...
//	sox_effect_t * e;
//	char * args[10];
//	char  buffer_ptr[100000];
//	size_t buffer_size;
//	sox_signalinfo_t signal;
//	sox_encodinginfo_t encode;
//	sox_encodinginfo_t outencode;
//	assert(argc == 3);
//	memset(&signal,0,sizeof(signal));
//	memset(&encode,0,sizeof(encode));
//	memset(&encode,0,sizeof(outencode));
//	signal.channels =1;
//	signal.rate =44100;
//	signal.precision =16;
//
...
//	outencode.bits_per_sample = 8;
//	outencode.encoding =SOX_ENCODING_ALAW;
//
//
//
//
...
//	assert(in = sox_open_read(argv[1], &signal, &encode, "raw"));
//
//	/* Open the output file; we must specify the output signal characteristics.
//	* Since we are using only simple effects, they are the same as the input
//	* file characteristics */
//	assert(out = sox_open_write(argv[2], &signal, &encode, "raw", NULL, NULL));
//
