...
#define THREAD_HANDLE_INIT(p) (*p=THREAD_HANDLE_INIT_VALUE)
#define THREAD_HANDLE_IS_INVALID(h) ( THREAD_HANDLE_INIT_VALUE!=h && h != INVALID_HANDLE_VALUE )
#else
#define THREAD_HANDLE_TYPE pthread_t
#define THREAD_HANDLE_INIT_VALUE 0
#define THREAD_RETURN_TYPE void*
#define THREAD_RETURN_VALUE  (void*)(0)
#define THREAD_HANDLE_INIT(p) memset(p, 0x0, sizeof(pthread_t))
#define THREAD_HANDLE_IS_INVALID(h) ( h > 0 )
#endif // _WINDOWS
