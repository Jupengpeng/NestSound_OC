...
//            [UIColor colorWithRed:77/255. green:77/255. blue:77/255. alpha:1]
...
//        
        ...
        self.line.backgroundColor = [UIColor hexColorFloat:@"f2d449"];
//        [UIColor colorWithRed:26/255. green:27/255. blue:30/255. alpha:1];
        self.line.tag=100;
        [self.segmentView addSubview:self.line];
        
        UILabel *middleLine = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 0.5, 30)];
        middleLine.center = CGPointMake(self.segmentView.frame.size.width/2.0f, self.segmentView.frame.size.height/2.0f);
        middleLine.backgroundColor = [UIColor hexColorFloat:@"808080"];
        [self.segmentView addSubview:middleLine];
    }
